...
function getThreadPicture(request) {
    return (threadId, imageId) => __awaiter(this, void 0, void 0, function* () {
        ...
        // Ugh...
        const queryThreadID = result.jsmods.require[0][3][1].query_metadata.query_path[0]
            .message_thread;
        const imageData = result.jsmods.require[0][3][1].query_results[queryThreadID].message_images
            .edges[0].node.image2;
        return imageData;
    });
}
