...
export declare function getSharedMedia(
  request: FacebookRequest,
): ({
  after,
  first,
  id,
}: GetSharedMedia.Request) => Promise<
  GraphQL.Connection<GetSharedMedia.Response.Node>
>;
...
export declare type GetSharedMedia = (
  options?: GetSharedMedia.Request,
) => Promise<GetSharedMedia.Response>;
