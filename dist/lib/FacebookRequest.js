  ...
  static getCurrentMessengerContext() {
    return __awaiter(this, void 0, void 0, function*() {
      return FacebookRequest.request(
        {
          method: 'get',
          baseURL: FacebookRequest.getDomainValue(
            FacebookRequest.Domain.default,
          ),
          url: '/messages',
        },
        data => ({
  ...
  request(options = {}) {
    return __awaiter(this, void 0, void 0, function*() {
      ...
      const baseRequestOptions = {
        ...
        method:
          this._options.forceGet && options.worksWithGetMethod
            ...
            : options.method,
        params:
          method === 'get' && withContext
            ? Object.assign({}, this.context, qs)
            : qs,
      };
      const requestOptions = Object.assign({}, options, baseRequestOptions, {
        headers: { 'content-type': 'application/x-www-form-urlencoded' },
        cancelToken: this.tokenSource.token,
        data: new URLSearchParams(
          FacebookRequest.stringifyQuery(
            Object.assign({}, withContext ? this.context : {}, data),
          ),
        ),
      });
      if (options.graphql) {
      ...
      return FacebookRequest.request(
        ...
        Object.assign({}, baseRequestOptions, {
          data: withContext
            ? Object.assign({ __user: this.context.__user }, data)
            : data,
        }),
      );
    });
